...
if(isset($_POST['update']))
{
   ...
   if(empty($missingdata))
   {
      foreach ($check_list as $id)
      {
         ...
         {
            $query="UPDATE product SET section='$sect' WHERE Id='$id'";
            ...
            <div>
               ...
               else
               {
                  ...
                  while($row=mysqli_fetch_array($response))
                  {
                     ...
                     <td class="text-center">'.$row['product_name'].'</td><td>
                     <select name="section['.$row['Id'].'][]" class="form-control"><option>'.$row['section'].'
